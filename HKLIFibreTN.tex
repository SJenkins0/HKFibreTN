...
\item v3.8 - Add fibre radon measurements.
\end{itemize}
...
The standard procedure applied for \hk material soak test is to leave the sample to soak undisturbed for 90 days. This period was estimated conservatively to be the period of water turnover in the \hk water tank. However, given the long lead time for purchase and delivery of the fibre, it was decided to perform a first measurement of the water properties after one month of soaking, before returning the samples to the containers for the remainder of the time.
...
To separate the results from the long fibre jacket lengths that will be in HK and the connectors, the end connectors of a ThorLabs fibre were cut off so that
 \SI{87}{\centi\meter} length of optical fibre jacket could be tested alone. These samples are showin in the emanation chambers in \cref{fig:boulbe_radon_photos}.
...
Additional measurements were conducted on the new connectors from ThorLabs, which are expected to have improved resistance to gadolinium corrosion. Tests were performed both with and without epoxy sealing to assess the effect the epoxy had on emanation. These are shown in \cref{fig:boulby_rad25064conn}. Taking the highest conservative measurement in each case resulted in \SI{1.031 \pm 0.110}{\milli\becquerel\per\connector} for the connector without epoxy, and \SI{0.813 \pm 0.049}{\milli\becquerel\per connector} for the connector with epoxy.
%
