...
\author{S.J. Jenkins\footnote{s.j.jenkins@liverpool.ac.uk}, B. Bogdan, N. Foster, U. Limbu, N. McCauley}
...
The second test involved leaving the laser on standby, connected to the power meter, for a number of days. This meant that random emission over a longer period of time could be checked for. {\bf currently running, will add results next week}

\section{Additional Fibre Tests}\label{sec:tests}
\subsection{Soak Testing}\label{sec:tests:sub:soak}
{\bf Yassine writing this now, will add here}
...
80			&	FC/PC		&	SMA			&	73				&	Barrel (all)$^\dagger$	\\
44			&	FC/PC		&	FC/PC		&	76				&	Deck	\\
44			&	SMA			&	SMA			&	8				&	Bottom	\\
10			&	FC/PC		&	SMA			&	5				&	Top ID inj. and top OD coll. \\
